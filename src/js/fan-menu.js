...
export class FanMenu {
  ...
  show(items, opts = {}) {
    ...
    // With back label: put the last item (Dashboard/Back) at 6 o'clock (90°)
    // Without back label: start from 3 o'clock (0°) so pairs go left-right
    const startAngle = backLabel
      ? 90 - (totalItems - 1) * arcAngle
      : 0;
